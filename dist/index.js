  ...
  return {
    ...
    visitor: {
      Program(path, {
        ...
        /^6\./.test(babel.version) ? { ...prevalBabelOptions
        } : {
          filename,
          babelrc: false,
          configFile: false,
        ...
        const moduleExports = { ...t.expressionStatement(t.assignmentExpression('=', t.memberExpression(t.identifier('module'), t.identifier('exports')), replacement)),
      ...
      TaggedTemplateExpression(path, {
        ...
        const code = prevalBabelOptions ? transform(rawCode, /^6\./.test(babel.version) ? { ...prevalBabelOptions
        } : {
          filename,
          babelrc: false,
          configFile: false,
      ...
      ImportDeclaration(path, {
        ...
        const absolutePath = p.resolve(p.dirname(filename), path.node.source.value);
